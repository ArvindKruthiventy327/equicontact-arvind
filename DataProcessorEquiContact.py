...
class DataProcessorEquiContact: 
    ...
    def proc_ep(self, ep): 
        ...
        for t in range(ep_len): 
            ...
            ep_data.append([data_obs, proc_action, 0.0])
...
if __name__ == "__main__": 
    cfg_path = "/home/blank/dl_proj/EquiContact-Simulation/data_collection/datasets/stack/DiTEquiContact_small_random.yaml"
    dp = DataProcessorEquiContact(cfg_path)
    dp.proc_dataset()